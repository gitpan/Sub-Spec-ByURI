...
sub new {
    ...
    my $h = $handlers{$scheme} // "Sub::Spec::ByURI::$scheme";
...
L<Sub::Spec::ByURI::pm> for local Perl modules/subroutines,
L<Sub::Spec::ByURI::http> for remote subroutines over HTTP.
